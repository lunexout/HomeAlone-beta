  ...
  return (
    <div className="projcard-container">
     <a
      ...
      <div className="projcard projcard-red">
        <div className="projcard-innerbox">
          ...
          <div className="projcard-textbox">
            <div className="projcard-title">BATUMI BUILD 2022</div>
            <div className="projcard-subtitle"></div>
            <div className="projcard-bar" />
            <div className="projcard-description">
              🟩 ჭკვიანი სახლის სისტემების კომპანია Home Alone <br />
              🛡 მე-11 საერთაშორისო სამშენებლო მასალების, ტექნოლოგიებისა და
              უძრავი ქონების გამოფენა <br />
              "BATUMI BUILD 2022"
              <br />
            </div>
            <div className="projcard-tagbox">
              <span className="projcard-tag">ExpoBatumi 2022</span>
      ...
      <a
        href="https://okmagazine.ge/ok-sheqmenit-idealuri-pirob/"
        target="blank"
      >
      ...
      <a
        href="https://okmagazine.ge/ok-marto-saxlshi-tqveni-srul/"
        target="blank"
      >
        <div className="projcard projcard-red">
          <div className="projcard-innerbox">
