        ...
        <div>
            ...
            <section className="free_model clear">
                ...
                <div className="xo_sec_6">
                    ...
                    <p>Built-in IR-Cut
                        <br />Night shooting is far to six meters
                        <br />No light pollution</p>
                </div>
                    ...
                    <div className="dt_container clearfix">
                        ...
                        <div className="dt_table clearfix">
                            <div className="dt_left">
                                <p className="dt_item left">Name：<em>Smart WiFi Camera</em></p>
                            </div>
                            <div className="dt_right">
                                <p className="dt_item right">Input：<em>5 VDC @ 1 A</em></p>
                            </div>
                            <div className="dt_line" />
                        </div>
                        <div className="dt_table clearfix">
                            <div className="dt_left">
                                <p className="dt_item left">Infrared LED：<em>10 pcs IR LED offer 6m sight distance in darkness</em></p>
                            </div>
                            <div className="dt_right">
                                <p className="dt_item right">Applicable Temperature：<em>-20° ~ 50°C</em></p>
                            </div>
                            <div className="dt_line" />
                        </div>
                        <div className="dt_table clearfix">
                            <div className="dt_left">
                                <p className="dt_item left">Chip model：<em>Hi3518E V200</em></p>
                            </div>
                            <div className="dt_right">
                                <p className="dt_item right">Size：<em>68*68*125mm</em></p>
                            </div>
                            <div className="dt_line" />
                        </div>
                        <div className="dt_table clearfix">
                            <div className="dt_left">
                                <p className="dt_item left">FPS：<em>30fps (adjustable)</em></p>
                            </div>
                            <div className="dt_right">
                                <p className="dt_item right">Compressed image format：<em style={{ fontSize: '16px' }}>H.264 MP/ HP Level4.0</em></p>
                            </div>
                            <div className="dt_line" />
                        </div>
                        <div className="dt_table clearfix">
                            <div className="dt_left">
                                <p className="dt_item left">Camera Lens：<em>113°</em></p>
                            </div>
                            <div className="dt_right">
                                <p className="dt_item right"><em>/ H.264 / MJPEG/&nbsp;JPEG compress standard</em></p>
                            </div>
                            <div className="dt_line" />
                        </div>
                        <div className="dt_table clearfix">
                            <div className="dt_left">
                                <p className="dt_item left">Night vision ：<em>Switch optical filter auto</em></p>
                            </div>
                            <div className="dt_right">
                                <p className="dt_item right">Resolution：<em>720P/VGA/QVGA</em></p>
                            </div>
                            <div className="dt_line" />
                        </div>
                        <div className="dt_table clearfix">
                            <div className="dt_left">
                                <p className="dt_item left">DDR：<em>128M</em></p>
                            </div>
                            <div className="dt_right">
                                <p className="dt_item right">Audio：<em>Tow way</em></p>
                            </div>
                            <div className="dt_line" />
                        </div>
                        <div className="dt_table clearfix">
                            ...
                            <div className="dt_right">
                                <p className="dt_item right">Sensors：<em>1/4” OV9732 1MP CMOS</em></p>
                            </div>
                            <div className="dt_line" />
                        </div>
                        <div className="dt_line" />
                ...
                <div className="xo_sec_9">
                    ...
                    <p>You can install more smart home products of &nbsp;ORVIBO ,they can all control by "HOME MATE"APP.
                        <br />Now,bring yours home .Your private customized.</p>
                </div>
            </section>
            <section className="pd_buy clear">
                <div className="pdbuy_center"><span className="pdbc_buyLeft">IP Camera</span>
