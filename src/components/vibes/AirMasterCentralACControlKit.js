      ...
      <div className="body_content" style={{ fontSize: "42.8125px" }}>
        ...
        <section className="air_sec2">
          ...
          <div className="as2_imgbox clear">
            <div className="as2i_img">
              <img
                src={`${dataJSON.API_URL}public/images/` + item.images[2].url}
                alt="sec2_bg"
              />
            ...
            <div className="as2i_img">
              <img
                src={`${dataJSON.API_URL}public/images/` + item.images[0].url}
                alt="sec2_bg"
              />
              <p>Inconvenient operation</p>
            </div>
            <div className="as2i_img">
              <img src={photo3} alt="sec2_bg" />
        ...
        <section className="air_sec4">
          ...
          <p>
            Based on the AI, big data, cloud service technologies, integrate the
            central air conditioner
            <br />
            into ORVIBO smart system through the AirMaster kit, achieve
            functions such as
            <br />
            environment detecting, smart control, temperature remote
            adjustment,one-key scene
            <br />
            control, etc..
          </p>
        </section>
