      ...
      <div className="mixpad__s2">
        ...
        >
          <div className="sec4__content ">
            ...
            <div className="sec__desc">
              The key to an advanced smart fingerprint lock is the lock
              cylinder. ORVIBO S2 selects the Auto smart lock cylinder
              integrated with electromechanics to ensure home safety from the
              inside to the outside. A good lock cylinder is the core of safety.
            </div>
          </div>
        </div>
        <div
          className="sec5 s__bg lazy"
        ...
        <div
          className="sec6 s__bg lazy"
          style={{ backgroundImage: `url(${photo6})` }}
        >
          <div className="">
            <div className="sec__title">Built-in 8 Kinds Of Sensors</div>
            <div className="sec__desc">
              In order to achieve a full range of defensive effects, the S2 door
              lock is equipped with a total of 8 sets of sensors,
              <br />
              which can accurately sense the state of the door lock. When the
              door lock is abnormal, it will feedback immediately
              <br />
              and be optimistic about the door at all times.
            </div>
          </div>
        </div>
        <div
          className="sec7 s__bg lazy"
        ...
        >
          <div className="">
            ...
            <div className="sec__desc">
              Adopting a new generation of Ultra Low Power Consumption™, the
              function becomes stronger and the power consumption is
              <br />
              reduced. It also expanded the capacity of the power storage
              warehouse, breaking through the 18-month power replacement
              <br />
              dilemma in the door lock industry, with a battery life of up to
              two and a half years. Not afraid of the short battery life of the
              <br />
              door lock, but the battery is not durable.
            </div>
          </div>
        </div>
        <div
          className="sec9 s__bg lazy"
        ...
        >
          <div className="sec9__content ">
            ...
            <div className="sec__desc">
              The German anti-drilling C-grade pure copper lock cylinder with
              built-in key unlocking sensor is
              <br />
              matched with austenitic 304 stainless steel lock body to achieve
              bank-level anti-riot and anti-
              <br />
              pry functions.
            </div>
          </div>
        ...
        <div
          className="sec10 s__bg lazy"
          style={{ backgroundImage: `url(${photo10})` }}
        >
          <div className="sec10__content ">
            <div className="sec__title">
              Encrypted Main Control Processor, Fingerprint Unlocking Is Safe
              And Fast
            </div>
            <div className="sec__desc">
              It adopts mature semiconductor fingerprint recognition technology,
              selects Swedish FPC fingerprint chip with 2020 new AI algorithm,
              <br />
              and uses asymmetric encrypted communication processing to lock the
              primary line of defense for door lock security.
            </div>
          </div>
        </div>
        <div
          className="sec11 s__bg lazy"
          style={{ backgroundImage: `url(${photo11})` }}
        >
          <div className=" sec__title">
        ...
        >
          <div className="sec12__content ">
            ...
            <div className="sec__desc">
              Door lock with Wi-Fi = slow? nonexistent. Oribo Black Warrior
              upgraded Wi-Fi networking technology,
              <br />
              which can wake up and connect to the network within 0.8S to
              achieve data communication.
            </div>
          </div>
        </div>
        <div className="sec14 s__bg lazy">
          ...
          <div
            className="sec14__bg s__bg lazy"
