    ...
    <div>
      ...
      <div className="im_sec2 clear">
        ...
        <div className="bg1 bg">
          <div className="shadow">
            <p>
              Forgot to turn off the tap when
              <br />
        ...
        <div className="bg3 bg">
          <div className="shadow">
            <p>
              Can't close the window when
              <br />
              there is suddenly rain
            </p>
          </div>
        </div>
        <div className="bg4 bg">
          <div className="shadow">
            <p>
              Slippery bathroom caused by
              <br />
              the surplus&nbsp;water and poor drainage
            </p>
          </div>
        </div>
      </div>
      <div className="im_sec3">
        <div className="content">
          ...
          <p className="s_p">
            Get notified when there is water leakage, water overflow and
            <br />
            water level change to efficiently avoid the accident and damage.
          </p>
      ...
      <div className="im_sec_4">
        <p className="tit">
          CLOSE THE WINDOW AUTOMATICALLY WHEN
          <br />
          DETECTING THE RAIN
        </p>
        <p className="cont">
          Put the water leakage sensor beside the window to detect if it’s
          raining, and link with
          <br />
          the window pushing device to close the window automatically if it
          detects the heavy rain.
        </p>
        <img
          alt="Home Alone"
          id="iphone6_1"
          src="img/iphone6_1-78eaba3749.png"
        />
      </div>
      <div className="im_sec_5">
        <p className="tit">APPLIED AT HUMID PLACES</p>
        <p className="cont">
          Put the water leakage sensor in the bathroom to detect the water level
          and efficiently
          <br />
          avoid family member falling down on the slippery ground.
        </p>
        <img
          alt="Home Alone"
          id="iphone6_2"
          src="img/iphone6_2-43bf246624.png"
        />
      </div>
