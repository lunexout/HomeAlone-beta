    ...
    return (
        <div>
            ...
            <section className="index_sec2">
                <div className="slider_box" style={{ height: '665.366px' }}>
                    <ul className="ib_slider" style={{ height: '665.366px', overflow: 'hidden' }}>
                        <div className="slidesjs-container" style={{ overflow: 'hidden', position: 'relative', width: '1098px', height: '777.204px' }}>
                            <div className="slidesjs-control" style={{ position: 'relative', left: '0px', width: '1098px', height: '777.204px' }}>
                                <li className="ibs1 slidesjs-slide" slidesjs-index={0} style={{ listStyleType: 'none', height: '665.366px', position: 'absolute', top: '0px', left: '0px', width: '100%', zIndex: 0, backfaceVisibility: 'hidden' }}></li>
                            </div>
                        </div>
                    </ul>
                    <ul className="ib_mark slidesjs-pagination clear">
                        <li className="slidesjs-pagination-item" style={{ overflow: 'hidden' }}>
                        ...
                        <li className="slidesjs-pagination-item" style={{ marginRight: 0, overflow: 'hidden' }}>
            ...
            <section className="sectczcs4">
                <div className="s4_mainbox main_content1">
                    <div className="s4m_title">
                        ...
                        <p>Adopt the C-Touch technology to achieve the fast response of 3ms.<br />And with the soft indicator in the night, locate the switch without any bother for your sleep.</p>
                    </div>
            ...
            <section className="sectczcs5">
                ...
                <p>The switch relay is well protected by the RelayPro-Tech™ technology.<br />Enable over 120 thousand of On/Off operations and 30 years of service life.</p>
                ...
                <p className="s5_tips">* Data is calculated based on the premise of 10 operations a day with normal temp.and humidity.<br />Actual effect may vary with environment.</p>
            </section>
            ...
            <section className="sectczcs8">
                ...
                <p>Improve the traditional lighting control by Touch Classic smart switches which are controlled by HomeMate APP,<br />and enable users to control the lighting anytime and anywhere.</p>
            </section>
            <section className="sectczcs9">
                <div className="s9_txtbox main_content1">
                    ...
                    <p>Just a simple click in the bed to turn off all the lighting via phone<br />APP without any bother to get up to turn off lights.</p>
                </div>
            ...
            <section className="sectczcs10">
                <div className="s10_txtbox main_content1">
                    ...
                    <p>Support Amazon Alexa and Google Home to enable the lighting voice control just<br />by speaking out the commands.</p>
                </div>
                <div className="chat1" />
