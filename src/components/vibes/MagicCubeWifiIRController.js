      ...
      <section className="free_model clear">
        <section className="xf_page xf_first_en">
          <div className="xf_container">
            ...
            <p className="xfe_txt">
              Remote control almost IR home appliances via smart phone.
              <br />
        ...
        <section className="xf_page xf_second_en">
          <div className="xfe_container">
            <p className="xc_title">
              ONE SMART PHONE CAN CONTROL MOST OF IR APPLIANCES
            </p>
            <p className="xc_txt">
              Support more than 8000 different brands of IR appliances
              <br />
              (TV, A/C, Fan, TV Box, Projector, DVD, Home Speaker, etc..) in the
              market.
            </p>
            <div className="xc_content">
              <img alt="Home Alone" src={photo1} />
              <div className="xc_air">
                <img alt="Home Alone" src={photo2} className="xa_wind" /> &nbsp;
                &nbsp; &nbsp; &nbsp;{" "}
                <img alt="Home Alone" src={photo3} className="xa_light" />
              </div>
              <div className="xc_tv">
                <img alt="Home Alone" src={photo4} className="xt_logo" /> &nbsp;
                &nbsp; &nbsp; &nbsp;{" "}
                <img alt="Home Alone" src={photo5} className="xt_logo_active" />{" "}
                &nbsp; &nbsp; &nbsp; &nbsp;{" "}
                <img alt="Home Alone" src={photo3} className="xt_light" />
              </div>
              <div className="xc_stb">
                <img alt="Home Alone" src={photo6} className="xs_dot" /> &nbsp;
                &nbsp; &nbsp; &nbsp;{" "}
                <img alt="Home Alone" src={photo7} className="xs_circle" />
              </div>
              <div className="xc_box">
                <img alt="Home Alone" src={photo3} className="xb_light" />{" "}
                &nbsp; &nbsp; &nbsp; &nbsp;{" "}
                <img alt="Home Alone" src={photo7} className="xb_circle" />
              </div>
              <div className="xc_sound">
                <div className="xs_left">
                  <img alt="Home Alone" src={photo8} className="xs_music" />{" "}
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;{" "}
                  <img alt="Home Alone" src={photo3} className="xs_light" />
                </div>
                <div className="xs_right">
                  <img alt="Home Alone" src={photo8} className="xs_music" />{" "}
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;{" "}
                  <img alt="Home Alone" src={photo3} className="xs_light" />
                </div>
              </div>
              <div className="xc_fan">
                <img alt="Home Alone" src={photo2} className="xf_wind" /> &nbsp;
                &nbsp; &nbsp; &nbsp;{" "}
                <img alt="Home Alone" src={photo6} className="xf_dot" />
              </div>
            </div>
        ...
        <section className="xf_page xf_third xf_third_en">
          <div className="xf_container">
            ...
            <p className="xt_txt">
              A magic cube instead of all your remote controllers
            </p>
          ...
          <div className="xf_container">
            ...
            <div className="xe_items">
              <div className="xe_item one">
                ...
                <p className="xi_txt">
                  With the scattering cone design to powerful 360°infrared
                  signaling.
                </p>
              </div>
              <div className="xe_item two">
                ...
                <p className="xi_txt">
                  Support more than 8000 different brands of IR appliances(TV,
                  A/C, fan, TV box, DVD, etc..) in the market.
                </p>
              </div>
              <div className="xe_item three">
                ...
                <p className="xi_txt">
                  uper power infrared transmitter,launch distance at least 10
                  metres.
                </p>
              </div>
              <div className="xe_item four">
                ...
                <p className="xi_txt">
                  The top shell adopts special infrared transmitting
                  material,Transmittance as high as 95%,stronger signal.
                </p>
              </div>
              <div className="xe_item five">
                ...
                <p className="xi_txt">
                  Open the home theater mode,all linkage appliances
                  automatically open.
                </p>
              </div>
            </div>
          ...
          <div className="xf_container">
            ...
            <div className="xt_table">
              <div className="xt_left">
                <p className="xt_item left">
                  Appearance: <em>Magic Cube Infrared Remote</em>
                </p>
              </div>
              <div className="xt_right">
                <p className="xt_item right">
                  Wireless Type: <em>WiFi 2.4GHz</em>
                </p>
              </div>
              <div className="xt_line" />
            </div>
            <div className="xt_table">
              <div className="xt_left">
                <p className="xt_item left">
                  Wireless Standard: <em>IEEE 802.11 b/g/n</em>
                </p>
              </div>
              <div className="xt_right">
                <p className="xt_item right">
                  Infrared &nbsp;Frequency: <em>20~60KHz</em>
                </p>
              </div>
              <div className="xt_line" />
            </div>
            <div className="xt_table">
              <div className="xt_left">
                <p className="xt_item left">
                  Case Material: <em>PC + ABS + TPU</em>
                </p>
              </div>
              <div className="xt_right">
                <p className="xt_item right">
                  Product Size: <em>53x53x54mm</em>
                </p>
              </div>
              <div className="xt_line" />
            </div>
            <div className="xt_table">
              <div className="xt_left">
                <p className="xt_item left">
                  Infrared Transmittance: <em>93%</em>
                </p>
              </div>
              <div className="xt_right">
                <p className="xt_item right">
                  Infrared Remote Distance: <em>8m+</em>
                </p>
              </div>
              <div className="xt_line" />
            </div>
            <div className="xt_table">
              <div className="xt_left">
                <p className="xt_item left">
                  Infrared Remote Angle: &nbsp; <em>360°</em>
                </p>
              </div>
              <div className="xt_right">
                <p className="xt_item right">
                  Supported IR Appliances Brand: <em>8000+</em>
                </p>
              </div>
              <div className="xt_line" />
            </div>
