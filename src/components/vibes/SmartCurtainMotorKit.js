    ...
    return (
        <div>
            ...
            <section className="sec1">
                ...
                <p>Remote Control | Voice Control | Silent Design | Easy Installation</p>
            </section>
            <section className="sec2">
                <div className="block1">
                    <h2>LIFE COULD BE SO SMART WITH VOICE CONTROL</h2>
                    <p>
                        Already compatible with Amazon Alexa and Google Assistant.<br />Speak
                        out the commands to easily control the curtains as your wish.
                    </p>
                    <div className="pic" />
            ...
            <section className="sec_add1">
                ...
                <p>
                    Includes the curtain motor, track, remote controller and lithium battery.
                </p>
            </section>
            <section className="sec3"><h2>STRENGTH AND IMPROVEMENT</h2></section>
            <section className="sec5">
                <div className="container">
                    ...
                    <div className="right">
                        ...
                        <p className="txt">
                            Support phone app and remote controller( &lt;30m) to open<br />and
                            close the curtains by one click.
                        </p>
                    </div>
                </div>
            </section>
            <section className="sec6">
                <div className="container">
                    ...
                    <div className="text">
                        ...
                        <p className="txt">
                            Pull the curtain down gently, smart curtain motor will be activated<br />to
                            work, and support manually control when power off.
                        </p>
                    </div>
                </div>
            </section>        
