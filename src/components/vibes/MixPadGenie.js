...
export const MixPadGenie = () => {
  return (
    <div>
      ...
      />
      <div className="elf">
        <div className="elf__banner s__bg">
          <video
            id="banner-video"
          ...
          <div id="banner-info" className="banner__info">
            <div className="banner__title">
              <span className="title_big">MixPad</span>{" "}
              <span className="title_big">Genie</span>
            </div>
        ...
        <div className="secginie1">
          <img
            alt="Home Alone"
            className="secginie1__img s__bg lazy"
            src={cid10}
          ></img>
        </div>
        <div className="secginie2 video-box">
          <video
            className="bg__video"
            width="100%"
            height="100%"
          ...
          <div className="video__mask">
            <div className="video__watch" data-list={0}>
              Watch the video
            </div>
          </div>
        </div>
        ...
        <div className="secginie4">
          <div className="fadeInUp secginie__title show">
          ...
          <img
            alt="Home Alone"
            className="secginie4__img lazy s__bg"
            src={cid8}
          ></img>
        </div>
        <div className="secginie5">
          <div className="secginie__title ">
          ...
          <div className="secginie5__prd">
            <img
              alt="Home Alone"
              className="prd__item1 s__bg lazy "
              src={cid3}
            ></img>
            <img
              alt="Home Alone"
              className="prd__item2 s__bg lazy "
              src={cid4}
            ></img>
            <img
              alt="Home Alone"
              className="prd__item3 s__bg lazy "
              src={cid5}
            ></img>
            <img
              alt="Home Alone"
              className="prd__item4 s__bg lazy "
              src={cid6}
            ></img>
          </div>
          <img alt="Home Alone" className="secginie5__img " src={cid7} />
        </div>
        <div className="secginie6">
          <div className="">
            ...
            <div className="secginie__desc">
              The dynamic super screen that changes automatically every day,
              <br />
              it collides with the wall color and panel color fiercely,
              refreshing your home every day.
            </div>
          </div>
          <video
            className="bg__video"
            ...
            muted
          />
          <div className="secginie6__remind">
            *Red, orange, blue, green and yellow will be available soon!
          </div>
        </div>
        <div className="secginie7 video-box">
          <video
            className="bg__video"
            width="100%"
            height="100%"
          ...
          <div className="video__mask">
            ...
            <div className="video__watch" data-list={1}>
              Watch the video
            </div>
          </div>
        </div>
        <div className="secginie8">
          <div className="">
            ...
            <div className="secginie__desc">
              A variety of communication protocols, which can be connected to a
              variety of home appliances such as air
              <br />
              conditioners, washing machines, TVs, clothes dryers, etc.
              Traditional home appliances become smart in
              <br />
          ...
          <img
            alt="Home Alone"
            className="secginie8__bg s__bg lazy"
            src={cid2}
          ></img>
        </div>
      </div>
