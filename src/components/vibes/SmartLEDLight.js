            ...
            <div class="downlight">
                ...
                <div class="led__secsll1 d__secsll">
                    ...
                    <div class="led__secsll2 d__secsll">
                        ...
                        <div class="secsll2__content">
                            <div class="secsll2__item">
                                <img alt="Home Alone" class="item__img s__bgsll"
                                    src={photo5}>
                                </img>
                    ...
                    <div class="led__secsll7 d__secsll">
                        <img alt="Home Alone" class="secsll7__logo s__bgsll"
                            src={photo3}>
                        </img>
                        <div class="secsll7__content">
                            <div class="secsll__title">zigbee full house smart interconnection</div>
                            <div class="secsll__desc">
                        ...
                        <img alt="Home Alone" class="secsll7__bg s__bgsll"
                            src={photo4}>
                        </img>
                    </div>
                    <div class="led__secsll8 d__secsll">
                        <div class="secsll__title">R90 high rendering restores true colors</div>
                        <div class="secsll__desc">
                        ...
                        <div>
                            <img alt="Home Alone" class="secsll8__bg s__bgsll"
                                src={photo7}>
                            </img>
                            <div class="img__desc">
