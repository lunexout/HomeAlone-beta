    ...
    <div>
      ...
      <section className="free_model clear">
          ...
          <ul className="clear">
            <li>
              ...
              <div>
                ...
                <p>
                  Connect multiple third-party RF products of different brands,
                  and provide more competitive smart home solution to users.
                </p>
              </div>
            </li>
            <li>
              <img src={photo2} alt="Allone Pro多功能智能主机" />
              <div>
                <div className="num num2" />
                <p className="title">
                  REAL-TIME UPDATION OF RF PROTOCOLS ON CLOUD
                </p>
                <p>
                  Supports many of RF433 products in the market including
                  curtain motors, lighting switches, clothes hanger, etc., and
                  improved the security by RF encryption.
                </p>
              </div>
            </li>
            <li style={{ marginRight: 0 }}>
              <img src={PHOTO3} alt="RF智能主机" />
              <div>
                <div className="num num3" />
                <p className="title">
                  SUPPORT 95% IR HOME APPLIANCES IN THE MARKET
                </p>
                <p>
                  Support most of the IR home appliances in the market including
                  A/C, TV, fan, projector, set top box, etc., and support 8000+
                  different models of IR devices.
                </p>
              </div>
            </li>
          </ul>
        ...
        <div className="rf_sec8">
          ...
          <p>
            Support Amazon Alexa and Google Home to enable the voice control on
            the IR home
            <br />
            appliances (TV, A/C) and the curtains.
          </p>
        </div>
        <div className="oi_six">
          <div className="os_container">
            ...
            <p className="os_txt">
              HomeMate APP from ORVIBO has user-friendly interactions and
              functions. By settings,
              <br />
              users can experience kinds of smart scenes in daily life. And with
              the open API,
              <br />
              HomeMate is available for manufacturers to customize their own
              APP.
            </p>
