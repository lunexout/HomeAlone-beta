    ...
    <div>
      ...
      <div className="c1Page">
        ...
        <div className="sec3">
          <div className="content">
            ...
            <div className="font24">
              Support mobile phone unlock，Suitable for
              <br />
        ...
        <div className="sec4">
          ...
          <div className="font24">
            The EMP protect technology is used to shield electromagnetic
            interference to
            <br />
        ...
        <div className="sec5">
          ...
          <div className="font24">
            It is equipped with the Swiss main control chip STM32, which has
            strong non-tamperable and non-
            <br />
            forgeable security attributes. Each unlocking has an unique key and
            certificate to ensure the
            <br />
            security of communication data.
          </div>
          <div className="infoLeft font26">APP encryption</div>
          <div className="infoRight font26">
            Communication
            <br />
            encryption
          </div>
        ...
        <div className="sec6">
          <div className="content">
            ...
            <div className="font24">
              ...
              <br />
              to realize remote security alarm.
            </div>
          </div>
        </div>
        <div className="sec7">
          <div className="content">
            ...
            <div className="font24">
              ...
              <br />
              effectively identify the fingerprints of the majority of the age
              <br />
              group, and intelligently predict the fingerprint changes without
              <br />
              the need for repeated entry. As the frequency of use increases,
              <br />
              so does the speed of recognition.
            </div>
          </div>
        </div>
        <div className="sec8">
        ...
        <div className="sec9">
          <div className="content">
            ...
            <div className="font24">
              Connect the door lock through Homemate APP. When the user
              <br />
              opens or closes the door, it will automatically link with other
              smart
              <br />
              home devices to achieve the full house linkage in different scene.
            </div>
          </div>
        </div>
      </div>
