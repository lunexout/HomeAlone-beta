      ...
      <div className="content">
        ...
        <div className="fontsizermania">
          ...
          <label htmlFor="question1" className="question">
            Will your books and materials withstand repeated use—are they
            satisfaction guaranteed?
          </label>
          <div className="answers">
            <p>
              Our hardcover books are library bound with exposed reinforced
              endsheets, which means extra lasting power, use after use. They
              are side sewn or section sewn, and all covers are laminated with
              glossy film. The books are vibrant, durable, and unconditionally
              guaranteed.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="answers">
            <p>
              ...
              pulp content, allowing our company to pursue its green goals while
              adding additional value for your eco-conscious purchases.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="answers">
            <p>
              Cavendish Square gladly provides library processing services.
              Please call 1-877-980-4450 or email Customer Service to learn more
              about processing and available and customizable options for your
              bookshelf needs.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="answers">
            <p>
              Yes, Cavendish Square keeps all customer processing specifications
              on file. You won't need to fill out library processing forms each
              time you order, we’ll do it for you. You can download a processing
              form here.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="answers">
            <p>
              We offer free processing on all orders over $350. On orders less
              than $350 the cost of barcodes and marc records is $25.00 per
              order.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="answers">
            <p>
              Accelerated Reader quizzes are available for many of our books.
              The AR Logo will appear where quizzes are available. For more
              about AR, please click here.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="answers">
            <p>
              Yes, all of our books are correlated to state and national
              standards. This web site’s correlation page will help you easily
              match our products with your state standards, and choose excellent
              selections for national standards. Otherwise, feel free to call us
              at 1-877-980-4450 and we’ll assist you in meeting your needs.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <label htmlFor="question8" className="question">
            Where can I find information about your authors or how can I contact
            them?
          </label>
          <div className="answers">
            <p>
              Cavendish Square commissions authors who are subject-matter
              experts and professional writers. If you’d like to learn more
              about an author’s background or if you wish to contact one of our
              authors, please click here to submit your contact information
        ...
        <div>
          ...
          <div className="answers">
            <p>
              Cavendish Square would like to hear from you—we’re dedicated to
              offering an ever-expanding array of solutions that will meet your
              needs. Any ideas, suggestions, or creative input that Cavendish
              Square can follow to help you achieve academic success, please
              feel free to share with our representatives. Artists and writers
              may also contact our Customer Service team for information about
              contributing to Cavendish.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="answers">
            <p>
              Cavendish Square titles are also available as eBooks. Also
              available are over 50 database titles. Click here for more
              information on our eBooks and digital databases. For a complete
              list of available digital resources, please call Customer Service
              at 1-877-980-4450 between 9AM and 5 PM EST, Monday through Friday.{" "}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="answers">
            <p>
              S&amp;L means school/library. Our school/library prices reflect a
              30% discount off list prices.
            </p>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="answers">
            <p>
              ...
              available for translation, subsidiary rights licensing, and usage
              other than original purposes.
            </p>
            <p>
              You can verify usage rights through Customer Service at
              1-877-980-4450 or by submitting your query through our Customer
              Service form.
            </p>
            <p>
              When contacting us, please have the book title/product name and
              ISBN that you’re inquiring about, along with a description of how
              you would like to use/reproduce the materials.
            </p>
            <p>
        ...
        <div>
          ...
          <div className="answers">
            <p>
              We produce several catalogs and brochures, covering our full line
              across all divisions. To download any brochures and catalogs in
              PDF form, or to request delivery of any of our current materials,
              please click here.{" "}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="answers">
            <p>
              ...
              suggestions, or comments here.&nbsp; To read our privacy policy,
              please click here.{" "}
            </p>
          </div>
        </div>
