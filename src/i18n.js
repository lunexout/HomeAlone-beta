...
const resources = {
  ...
  ge: {
    translation: {
      ...
      "prodiskr2": "MIXPAD-ის უნივერსალური სამართავი პანელი",
      "prodiskr3": "ერთი პანელი, სრულად დაჭკვიანებული სახლი",
      "prodiskr4": "მძლავრი სისტემის აპარატურა აერთიანებს სხვადასხვა მოწყობილობების ფუნქციებს. მოსახერხებული ფუნქციონალი და შესანიშნავი ინტერაქცია ყოველდღიურობას უფრო ბუნებრივს და კომფორტულს ხდის.",
      "prodiskr5": "მთავარი AI 3.0",
      "prodiskr6": "შკვიანი სახლის ოპერაციული სისტემა",
      ...
      "prodiskr8": "სახლის სრული განათება",
      "prodiskr9": "ერთ პანელს შეუძლია გააკონტროლოს რამოდენიმე განათების სისტემა",
      "prodiskr10": "გამორთოს ყველა განათება ერთი ღილაკით და",
      "prodiskr11": "არ დაკარგოთ დრო მათი სათითაოდ გამორთვისთვის.",
      "prodiskr12": "მხოლოდ ერთი ოპერაციით შეასრულეთ უამრავი ფუნქცია",
      "prodiskr13": "მოსახერხებელი ინტერფეისი.",
      "prodiskr14": "მობილური აპლიკაციიდან დისტანციური მართვა",
      "prodiskr15": "ზაფხულში ჩართეთ კონდეციონერი დისტანციურად, იგრძენით კომფორტი სახლში მისვლისთანავე.",
      "Back": "უკან",
